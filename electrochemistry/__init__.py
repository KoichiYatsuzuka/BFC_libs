...
from typing import Final, NewType, Optional, Union, TypeAlias, Self, overload, override
...
class Voltammogram(cmn.DataSeriese[Potential, Current]):
    ...
    @cmn.immutator
    def IR_correction(self, resistance: Resistance):
        new_voltammogram = Voltammogram(
...
class EIS(cmn.DataSeriese[ResistanceArray, ResistanceArray]):
    ...
    _applied_potential: Optional[Potential] = None
    @property
    def applied_potential(self)->Optional[Potential]:
